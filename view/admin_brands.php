            ...
            <div class="sidebar-wrapper active">
                <div class="sidebar-header position-relative">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="logo">
                            <a href="index.html"><img src="admin/assets/images/logo/logo.svg" alt="Logo" srcset=""></a>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6 order-md-2 order-first">
                            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                <button class="btn btn-primary me-1 mb-1" data-bs-toggle="modal" data-bs-target="#inlineForm">Add Brand</button>
                            </nav>
                        </div>
                    </div>
                </div>
                            ...
                            <form action="../actions/add_brand.php" method="post">
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-light-secondary" data-bs-dismiss="modal">
                                        ...
                                        <span class="d-none d-sm-block">Close</span> <a href= "login/logout.php"></a>
                                    </button>
                                    <button type="submit" class="btn btn-primary ml-1" data-bs-dismiss="modal" name="submit">
                                        <i class="bx bx-check d-block d-sm-none"></i>
                                        <span class="d-none d-sm-block">Add brand</span>
                                    </button>
                                </div>
                            </form>
                        </div>
